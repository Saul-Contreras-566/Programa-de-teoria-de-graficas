...
all:
	$(COMPILER) -o $(NAME)-Linux -I$(HEADERS_DIR) $(FLAGS) $(SOURCE) $(LINKERS)

windows:
	x86_64-w64-mingw32-g++ -o $(NAME)-Windows.exe -I$(HEADERS_DIR) $(FLAGS) $(SOURCE) $(LINKERS)
